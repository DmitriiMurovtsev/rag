...
Если в базе совсем нет информации, база пуста, то прямо скажи:
«К сожалению, я не нашёл информации по запросу [вопрос] в базе компании.»
Но если есть хотя бы одна похожая информация, то тогда ответь на вопрос, исходя из найденной информации.
