...
Если база содержит хотя бы одну частично или тематически релевантную запись (например, синоним, переформулировку, близкий по смыслу запрос), используй её для ответа на вопрос, 
но только если суть вопроса от пользователя и суть вопроса или ответа в найденном фрагменте совпадают.
